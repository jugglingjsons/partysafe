      ...
      <div className="flex justify-center px-4 max-w-7xl mx-auto space-x-5">
        <Link href="/library" passHref>
          <div className="flex flex-col items-center">
            ...
            <span className="mt-2 text-sm">{t("library")}</span>{" "}
            {/* Translate 'library' */}
          </div>
        </Link>
        <Link href="/support" passHref>
          <div className="flex flex-col items-center">
            ...
            <span className="mt-2 text-sm">{t("support")}</span>{" "}
            {/* Translate 'support' */}
          </div>
        </Link>
        <Link href="/dialogues" passHref>
          <div className="flex flex-col items-center">
            ...
            <span className="mt-2 text-sm">{t("dialogue")}</span>{" "}
            {/* Translate 'dialogue' */}
          </div>
        </Link>
        <Link href="/favorites" passHref>
          <div className="flex flex-col items-center">
            ...
            <span className="mt-2 text-sm">{t("favorites")}</span>{" "}
            {/* Translate 'favorites' */}
          </div>
        </Link>
        <Link href="/about" passHref>
          <div className="flex flex-col items-center">
            ...
            <span className="mt-2 text-sm">{t("about")}</span>{" "}
            {/* Translate 'about' */}
          </div>
        </Link>
      </div>
      <p className="text-center mt-4">
        &copy; 2023 PartySafe. {t("allRightsReserved")}
      </p>{" "}
